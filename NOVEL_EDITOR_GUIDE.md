...
- `novel` - Полнофункциональный редактор на базе Tiptap с AI-подобным интерфейсом

### Файлы
- `src/components/NovelEditor.tsx` - Компонент редактора
...
### Преимущества Novel
- **Интуитивный интерфейс** - Всплывающее меню при выделении текста
- **Slash команды** - Быстрый доступ к функциям через `/`
- **Современный дизайн** - Минималистичный и чистый UI
- **Расширяемость** - Построен на Tiptap, легко кастомизируется
...
- Убедитесь, что пакет установлен: `npm install novel`
- Novel требует клиентский рендеринг - компонент помечен как `'use client'`
