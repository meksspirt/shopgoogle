...
## 5. Інтеграція віджету Нової Пошти (25.11.2025)
- ✅ Створено компонент `NovaPoshtaWidget` (src/components/NovaPoshtaWidget.tsx)
- ✅ Замінено поля вводу міста та відділення на інтерактивний віджет НП
- ✅ Віджет стилізований під дизайн сайту (темна тема)
- ✅ Додано підтримку геолокації для автоматичного визначення міста
- ✅ Додано валідацію: кнопка оплати неактивна без вибору відділення
- ✅ В адмінці тепер відображається:
  - Місто доставки
  - Назва відділення НП
  - ID відділення (для API інтеграції)
  - Повна адреса відділення
- ✅ Додано нове поле в БД: `nova_poshta_warehouse_id`
...
### Документація:
- Швидкий старт: `QUICK_START_NOVA_POSHTA.md`
- Детальна документація: `NOVA_POSHTA_INTEGRATION.md`
- Офіційна інструкція НП: https://developers.novaposhta.ua/pages/instrukciya-z-integraciyi-widget-viboru-pidrozdilu-dostavki
